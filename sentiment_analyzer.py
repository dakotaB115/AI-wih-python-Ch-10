...
if __name__=='__main__':
    ...
    # Define the train and test slit (80% and 20%)
    threshold = 0.8
    num_pos = int(threshold * len(feature_pos))
    num_neg = int(threshold * len(feature_neg))

    # Create training and training datasets
    features_train = feature_pos[:num_pos] + feature_neg[:num_neg]
    features_test = feature_pos[num_pos:] + feature_neg[num_neg:]
    ...
    input_reviews = [
        'This movie was fucking trash don\'t watch it.',
        'I loved the movie.',
        'The costumes in this movie were great.',
        'I think the story was terrible and the characters were very weak.',
        'People say that the director of the movie is amazing.'
        'This is such a great movie. I\'ll recommend it to everyone.'
    ]
